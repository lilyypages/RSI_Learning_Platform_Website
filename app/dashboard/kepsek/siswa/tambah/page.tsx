...
export default function TambahSiswaPage() {
  ...
  // Fetch data kelas untuk Dropdown Select
  useEffect(() => {
    async function fetchClasses() {
      try {
        ...
        if (res.ok) {
          // Menyesuaikan jika response dibungkus objek { classes: [...] } atau langsung array
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Jika sukses, simpan data response untuk ditampilkan di Success State
              ...
              <div className="border-t pt-3 mt-2 space-y-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text" // Menggunakan text agar operator pendaftaran tahu password sementara yang diberikan
